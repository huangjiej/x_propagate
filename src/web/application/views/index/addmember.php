...
<form id="post-form" method="post" action="">
    <div class="weui_cells_title">添加会员</div>
    <div class="weui_cells weui_cells_form">
        ...
        <div class="weui_cell">
            ...
            <div class="weui_cell_bd weui_cell_primary">
                <input name="tag" class="weui_input" type="text"
                       placeholder="请输入标签(空格可输入多个)">
            </div>
        </div>
