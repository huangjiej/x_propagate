<article class="index" id="lazy">
    <section class="">
        ...
        <div class="nav j-flag">
            <a href="/index/member">
                <img src="/images/wdhy.png" class="ico">
                <p>我的会员</p>
            </a>
            <a href="/index/myclub">
                <img src="/images/wdjlb.png" class="ico">
                <p>我的俱乐部</p>
            </a>
            <a href="/index/news">
            ...
            <a href="/index/card/?id=<?= $wx_id ?>">
                <img data-src="/images/ico4.jpg" src="/images/ico4.jpg" class="ico">
                <p>教练名片</p>
            </a>
        </div>
        <div class="split"></div>
        <div class="j-flag-thank">
            <a style="width: 100%" href="/thank/index">
                <div style="position: relative;" class="thank-wall">
                    <img style="height: 100%;"  data-src="<?= $thank['banner'] ?>" src="<?= $thank['banner'] ?>" alt="">
                ...
                <div class="thank-info" style="display: table;width: 100%;">
                    ...
                    <div style="display: table-cell;">
                        <img data-src="/images/wyge.jpg?22222" src="/images/wyge.jpg?22222" style="height: .6rem" alt="">
                    </div>
                </div>
            </a>
        </div>
